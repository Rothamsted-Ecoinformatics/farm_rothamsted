...
/**
 * Provides an interface for research experiment entities.
 */
interface RothamstedExperimentInterface extends ContentEntityInterface, EntityChangedInterface, RevisionLogInterface, EntityOwnerInterface {
