...
class ExperimentVariableForm extends ExperimentFormBase {
  ...
  public function access(AccountInterface $account, PlanInterface $plan) {
    return $plan->access('update', $account, TRUE)->andIf(AccessResult::allowedIfHasPermission($account, 'upload rothamsted_experiment plan variables'));
  }
