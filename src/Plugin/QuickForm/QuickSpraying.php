...
class QuickSpraying extends QuickExperimentFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    // Spray days count.
    $spraying['sprayed_days']['spray_day_count'] = [
      '#type' => 'select',
      '#title' => $this->t('How many spray days were there?'),
      '#options' => array_combine(range(1, 5), range(1, 5)),
      '#default_value' => 1,
      '#ajax' => [
        'callback' => [$this, 'sprayDaysCallback'],
        'event' => 'change',
        'wrapper' => 'farm-rothamsted-spraying-days',
      ],
    ];
    ...
    // Add fields for each product.
    $spraying['sprayed_days']['days']['#tree'] = TRUE;
    ...
    for ($i = 0; $i < $quantities; $i++) {
      ...
      // Area sprayed units.
      $spraying['sprayed_days']['days'][$i]['area_sprayed_units'] = [
        '#type' => 'radios',
      ...
      // RRES product number.
      $spraying['sprayed_days']['days'][$i]['rres_product_number'] = [
        '#type' => 'textfield',
      ...
      // Product quantity.
      $spraying['sprayed_days']['days'][$i]['product_quantity'] = [
        '#type' => 'number',
      ...
      $spraying['sprayed_days']['days'][$i]['product_quantity_units'] = [
        '#type' => 'radios',
      ...
      // Water volume.
      $spraying['sprayed_days']['days'][$i]['water_volume'] = [
        '#type' => 'number',
      ...
      $spraying['sprayed_days']['days'][$i]['cossh_hazard_assessments'] = [
        '#type' => 'checkboxes',
      ...
      $spraying['sprayed_days']['days'][$i]['spray_nozzle'] = [
        '#type' => 'select',
      ...
      // Wind speed (kph).
      $spraying['sprayed_days']['days'][$i]['wind_speed'] = [
        '#type' => 'number',
      ...
      $spraying['sprayed_days']['days'][$i]['wind_direction'] = [
        '#type' => 'select',
      ...
      $spraying['sprayed_days']['days'][$i]['temperature'] = [
        '#type' => 'number',
      ...
      // Weather.
      $spraying['sprayed_days']['days'][$i]['weather'] = [
        '#type' => 'select',
      ...
      // Speed driven.
      $spraying['sprayed_days']['days'][$i]['speed_driven'] = [
        '#type' => 'number',
      ...
      // Speed driven units.
      $spraying['sprayed_days']['days'][$i]['speed_driven_units'] = [
        '#type' => 'radios',
      ...
      // Pressure - number.
      $spraying['sprayed_days']['days'][$i]['pressure'] = [
        '#type' => 'number',
      ...
      // Tank mix ID.
      $spraying['sprayed_days']['days'][$i]['tank_mix_id'] = [
        '#type' => 'textfield',
      ...
      $spraying['sprayed_days']['days'][$i]['tank_volume_remaining'] = [
        '#type' => 'number',
      ...
      $spraying['sprayed_days']['days'][$i]['tank_volume_remaining_units'] = [
        '#type' => 'radios',
      ...
      $spraying['sprayed_days']['days'][$i]['rinsed'] = [
        '#type' => 'checkbox',
      ...
      $spraying['sprayed_days']['days'][$i]['clear_washed'] = [
        '#type' => 'checkbox',
  ...
  /**
   * Form ajax function for spray days quick form.
   */
  public function sprayDaysCallback(array $form, FormStateInterface $form_state) {
    return $form['spraying']['sprayed_days']['days'];
  }
