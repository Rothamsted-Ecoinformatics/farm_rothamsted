...
- Add pagination warning to the plots tab. [#797](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/797)
...
- Disable email notifications if user is blocked. [#840](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/840)
...
- Restrict permissions for downloading experiment data to named researchers. [#825](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/825)
- Replace Group logic with Equipment Taxonomy. [#792](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/792)
...
- Add dependencies for farm_rothamsted_export.

## [2.27.0](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/milestone/48)
...
- Add individual status change actions for plans. [#663](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/663)
...
- Only alter rothamsted_experiment plan view.

## [2.24.0](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/milestone/45)
...
- Changes for user proposals and study plans on dashboard. [#679](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/679)

## [2.23.0](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/milestone/44)
...
- Experiment module: Duplicate proposals. [#659](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/659)
- E-mail notification setting for experiments. [#667](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/667)
- E-mail notification setting for proposals. [#668](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/668)

## [2.22.0](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/milestone/43)
...
- Clarify research entity labels in views. [#652](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/652)
...
- Change description of Research Program notifications.
...
- Require plot number and plot ID for geometry uploads. [#632](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/632)
...
- Allow proposal contacts, statistician and data steward to edit. [#591](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/591)
...
- Add All tab for plans. [#503](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/503)

## [2.16.1](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/milestone/34) 2023-08-22
...
- Add notification setting so researchers can turn off email notifications. [#485](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/485)

### Changed

- Experiment study period ID a required field. [#530](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/530)
- Use farmOS core secondary local task provider.

### Fixed

- Error message when unselecting a product type. [#531](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/issues/531)

## [2.15.0](https://github.com/Rothamsted-Ecoinformatics/farm_rothamsted/milestone/36) 2023-08-02
